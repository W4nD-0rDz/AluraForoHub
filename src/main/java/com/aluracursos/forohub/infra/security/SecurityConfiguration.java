    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/respuestas/{id}").hasAnyRole("INSTRUCTOR", "ESTUDIANTE", "MODERADOR", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.DELETE, "/topicos/{id}").hasAnyRole("ESTUDIANTE", "MODERADOR", "ADMINISTRADOR")
